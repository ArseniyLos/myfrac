...
$sth = $dbh->prepare("SELECT * FROM `news` WHERE `id` = '$gid'");
$sth->execute();
...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <?php foreach ($list as $row): ?>
    <h1><?php echo $row['name']; ?></h1><br><br>
    <p class="fs-5"><?php echo $row['full']; ?></p><br>
    <h1 class="fs-5">Автор: <?php echo $row['author']; ?></h1>
  <?php endforeach; ?>
