...
$stmt1->bind_param("ss", $user_id, $company);
$stmt1->execute();
...
if ($org1 != "") {
  ...
  <ul class="nav nav-pills flex-column"><li class="nav-item">
    <a class="nav-link active" href="profile_log.php">
...
?>
    ...
    <div class="shadow p-3 mb-1 card-body bg-body rounded" style="max-width: 500px;">
