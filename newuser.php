...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <div class="mb-3">
    ...
    <label class="zag form-label">Личный номер</label>
    <input name="number" class="form-control" style="max-width: 300px;"><br>
<button class="btn btn-outline-success" type="submit">Принять</button>
    </form>
  </main>
