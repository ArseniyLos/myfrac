...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <form action="vendor/addnew.php" method="post">
  <div class="mb-3">
    <input type="hidden" name="author" value="<?= $_SESSION['user']['name'] ?>">
    <input type="hidden" name="frac" value="<?= $_SESSION['user']['org1'] ?>">
    <label class="zag form-label">Категория</label>
    <select name="type" class="form-select" style="max-width: 300px;" aria-label="Пример выбора по умолчанию">
  ...
  <option>Прочее</option>
    ...
    <input name="zag" class="form-control" style="max-width: 400px;"><br>
    <label class="form-label">Краткое описание</label>
    <textarea name="short" class="form-control" style="max-width: 400px;"></textarea><br>
    <label class="form-label">Текст</label>
    <textarea name="text" class="form-control" style="max-width: 400px;"></textarea><br>
    <label class="form-label">URL картинки</label>
    <input name="img" class="form-control" style="max-width: 400px;"><br>
    <br><br>
